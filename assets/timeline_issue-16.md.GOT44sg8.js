import{_ as s,c as n,o as a,a5 as p}from"./chunks/framework.CByBVyi2.js";const h=JSON.parse('{"title":"","description":"","frontmatter":{},"headers":[],"relativePath":"timeline/issue-16.md","filePath":"timeline/issue-16.md","lastUpdated":1726141559000}'),e={name:"timeline/issue-16.md"},l=p(`<h3 id="proxy-pass的用法" tabindex="-1">proxy_pass的用法 <a class="header-anchor" href="#proxy-pass的用法" aria-label="Permalink to &quot;proxy_pass的用法&quot;">​</a></h3><div class="tip custom-block"><p class="custom-block-title">原文地址</p><p><a href="https://github.com/jynba/jynba.github.io/issues/16" target="_blank" rel="noreferrer">nginx 反向代理和负载均衡 | GitHub</a></p></div><blockquote><p>案例1代理到哔哩哔哩</p></blockquote><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>location / {</span></span>
