import{_ as n,c as s,o as a,a5 as p}from"./chunks/framework.CByBVyi2.js";const d=JSON.parse('{"title":"浅拷贝与深拷贝","description":"","frontmatter":{},"headers":[],"relativePath":"other/java/copy.md","filePath":"other/java/copy.md","lastUpdated":1733110755000}'),e={name:"other/java/copy.md"},l=p(`<h1 id="浅拷贝与深拷贝" tabindex="-1">浅拷贝与深拷贝 <a class="header-anchor" href="#浅拷贝与深拷贝" aria-label="Permalink to &quot;浅拷贝与深拷贝&quot;">​</a></h1><h2 id="前言" tabindex="-1">前言： <a class="header-anchor" href="#前言" aria-label="Permalink to &quot;前言：&quot;">​</a></h2><p>前面我中谈到了 clone（浅拷贝），另外关于克隆网上也有很多的写过这方面的问题。 我在这里记录一下我遇到的问题和使用 clone 的方法。</p><h2 id="知识点一-什么是浅拷贝" tabindex="-1">知识点一：什么是浅拷贝？ <a class="header-anchor" href="#知识点一-什么是浅拷贝" aria-label="Permalink to &quot;知识点一：什么是浅拷贝？&quot;">​</a></h2><p>我们这里说的浅拷贝是指我们拷贝出来的对象<em>内部的引用类型变量和</em>原来对象内部引用类型变量是同一引用（指向同一对象）。 但是我们拷贝出来的对象和新对象不是同一对象。 简单来说，新（拷贝产生）、旧（元对象）对象不同，但是内部如果有引用类型的变量，新、旧对象引用的都是同一引用。</p><h2 id="知识点二-什么是深拷贝" tabindex="-1">知识点二：什么是深拷贝？ <a class="header-anchor" href="#知识点二-什么是深拷贝" aria-label="Permalink to &quot;知识点二：什么是深拷贝？&quot;">​</a></h2><pre><code>深拷贝：全部拷贝原对象的内容，*包括内存的引用类型也进行拷贝
</code></pre><h2 id="知识点三、java-拷贝-clone-的前提" tabindex="-1">知识点三、java 拷贝（clone）的前提： <a class="header-anchor" href="#知识点三、java-拷贝-clone-的前提" aria-label="Permalink to &quot;知识点三、java 拷贝（clone）的前提：&quot;">​</a></h2><p>1.首先我们需要知道Object类中一个clone()的方法，并且是protected关键字修饰的本地方法(使用native关键字修饰)，我们完成克隆需要重写该方法。 注意：按照惯例重写的时候一个要将protected修饰符修改为public，这是JDK所推荐的做法，但是我测试了一下， 复写的时候不修改为public也是能够完成拷贝的。但是还是推荐写成public。</p><p>2.我们重写的clone方法一个要实现Cloneable接口。虽然这个接口并没有什么方法，但是必须实现该标志接口。 如果不实现将会在运行期间抛出：CloneNotSupportedException异常</p><p>3.Object中本地clone()方法，默认是浅拷贝</p><h2 id="浅拷贝案例" tabindex="-1">浅拷贝案例 <a class="header-anchor" href="#浅拷贝案例" aria-label="Permalink to &quot;浅拷贝案例&quot;">​</a></h2><div class="language- vp-adaptive-theme line-numbers-mode"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>    public class Person implements Cloneable{</span></span>
<span class="line"><span>    private String name;</span></span>
<span class="line"><span>    private int age;</span></span>
<span class="line"><span>    private int[] ints;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    public int[] getInts() {</span></span>
<span class="line"><span>        return ints;</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    public Person(String name, int age, int[] ints) {</span></span>
<span class="line"><span>        this.name = name;</span></span>
<span class="line"><span>        this.age = age;</span></span>
<span class="line"><span>        this.ints = ints;</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
<span class="line"><span>    public void setInts(int[] ints) {</span></span>
<span class="line"><span>        this.ints = ints;</span></span>
<span class="line"><span>    }</span></span>
<span class="line"><span></span></span>
